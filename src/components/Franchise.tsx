...
export function Franchise() {
  ...
  return (
    <section id="franchise" className="section-padding-landing bg-beige relative overflow-hidden select-none">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8">
          {franchiseSteps.map((step, idx) => {
            ...
            <div
              ...
              className={`reveal-${idx % 2 === 0 ? "left" : "right"} reveal premium-card premium-card-hover group p-8 flex flex-col justify-between min-h-[270px] relative`}
            >
